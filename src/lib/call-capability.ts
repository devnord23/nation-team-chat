...
export function callCapabilityHelp(
    ...
    switch (capabilities.dictation.reasonCode) {
      ...
      case "desktop-app-required":
        return {
          ...
          reason: "Open this workspace in NATION Team for macOS to make calls with on-device speech recognition.",
        };
  ...
  if (!speechServiceAvailable) {
    return {
      ...
      reason: "The speech service is unavailable in this app build. Restart or update NATION Team.",
    };
  }
  return null;
}
