...
import type { NationColor } from "./store.ts";
...
const COLORS = [
  ...
  "teal",
  "coral",
] as const satisfies readonly NationColor[];
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an NATION package" }),
