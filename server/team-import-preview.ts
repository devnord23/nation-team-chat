...
import { parseTeamBackup, TEAM_BACKUP_CONTENTS } from "../shared/team-backup.ts";
...
export function teamImportPreview(manifest: unknown): PendingTeamImport {
  ...
  if (root.format !== "openmaus.team") throw new Error("This is not a Nation Team Chat backup, BotMRR playbook or legacy team.");
