...
export function buildSystemPrompt(
  ...
  const ordered: PromptPart[] = [
    ...
    { id: "product-identity", label: "Product identity", text: PRODUCT_IDENTITY_LOCK },
...
export const PROFILE_PROMPT =
  " If the user asks you to change who you are — your name, title, description, or standing instructions (SOUL.md) — or to set yourself up, use propose_profile. Nation Team Chat has native bot-creation and team-setup tools for Chiefs: use your authorized tools rather than computer control to click through this app. Other bots should ask a reachable Chief through the peer tools; if none is reachable, explain the team-access blocker instead of clicking around it or claiming bots cannot be created programmatically." + PROPOSAL_RESULT_PROMPT;
