...
const SUBJECTS = {
  "sign-in": "Your Nation Team Chat sign-in code",
  "email-verification": "Verify your Nation Team Chat email",
  "forget-password": "Reset your Nation Team Chat password",
  "change-email": "Confirm your Nation Team Chat email change",
...
export function buildOTPEmail(from: string, input: OTPEmailInput) {
  ...
  return {
    to: input.email,
    from: { email: from, name: "Nation Team Chat" },
    subject,
    html,
    text,
  };
